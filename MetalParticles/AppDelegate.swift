...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func deleteItemsPendingDelete()
    {
        ...
        {
            if let fetchResults = _managedObjectContext.executeFetchRequest(fetchRequest, error: nil) as? [EmergentEntity]
            {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Emergent", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Emergent")
